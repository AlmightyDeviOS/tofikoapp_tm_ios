        ...
        didSet {
            if navBackButton == true{
                if btnNavBack == nil{
                    ...
                    self.bringSubview(toFront: btnNavBack)
                }
    ...
    @IBInspectable internal var navMenuButton: Bool = false{
        didSet {
            if navMenuButton == true {
                ...
                self.bringSubview(toFront: btnNavOption)
    ...
    @IBInspectable var navRightButton: Bool = false{
        didSet {
            if navRightButton == true{
                ...
                btnNavCancel.setTitle("Cancel", for: .normal)
                btnNavCancel.setTitle("Cancel", for: .highlighted)
...
//                btnNavCancel.titleLabel?.font = TRFont.VerdanaRegular(16)
                ...
                self.bringSubview(toFront: btnNavCancel)
            } else {
